...
public class ConvenioController {
	...
	public ModelAndView salvarConvenio(@Valid Convenio convenio, BindingResult bindingResult, @RequestParam("fixo") Boolean fixo) {
